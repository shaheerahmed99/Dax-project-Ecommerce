...
export class AuthController {
  ...
  @ApiBody({ schema: { example: { name: 'John Doe', email: 'abc@gmail.com', password: '123456' } } })
  ...
  @ApiBody({ schema: { example: { email: 'abc@gmail.com'} } })
  ...
  @ApiBody({ schema: { example: { email: 'abc@gmail.com', password: '123456' } } })
  ...
  @ApiBody({ schema: { example: { email: 'abc@gmail.com',oldPassword: '123456',newPassword: '123456789'} } })
  ...
  @ApiBody({ schema: { example: { name: 'John Doe', email: 'abc@gmail.com',address : "abc,karachi,pakistan",phoneNo:"+92******"} } })
